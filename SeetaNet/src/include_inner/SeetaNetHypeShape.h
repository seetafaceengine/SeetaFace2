...
public:
	...
	explicit HypeShape(const std::vector<int> &shape) : m_shape(shape)
	{
		// update weights
		if (m_shape.empty())
			return;
...
#define LOOP_END(i) index += arg##i; return index;
	...
	T to_index(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5)
	{
		LOOP_HEAD(6)
	...
	///
	T to_index(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6)
	{
		LOOP_HEAD(7)
			LOOP_ON(0) LOOP_ON(1) LOOP_ON(2) LOOP_ON(3) LOOP_ON(4)
			LOOP_ON(5)
	...
	T to_index(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7)
	{
		LOOP_HEAD(8)
			LOOP_ON(0) LOOP_ON(1) LOOP_ON(2) LOOP_ON(3) LOOP_ON(4)
			LOOP_ON(5) LOOP_ON(6)
	...
	T to_index(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8)
	{
		LOOP_HEAD(9)
			LOOP_ON(0) LOOP_ON(1) LOOP_ON(2) LOOP_ON(3) LOOP_ON(4)
	...
	T to_index(int arg0, int arg1, int arg2, int arg3, int arg4, int arg5, int arg6, int arg7, int arg8, int arg9)
	{
		LOOP_HEAD(10)
			LOOP_ON(0) LOOP_ON(1) LOOP_ON(2) LOOP_ON(3) LOOP_ON(4)
