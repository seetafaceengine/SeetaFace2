...
namespace seeta
{
	namespace v2
	{
		...
		public:
			 ...
			 */
			SEETA_API float evaluate(const SeetaImageData &image, const SeetaRect &face, const SeetaPointF *points) const;
			 ...
			 */
			SEETA_API int evaluate(const SeetaImageData &image, const SeetaRect &face, const SeetaPointF *points, float &score) const;
